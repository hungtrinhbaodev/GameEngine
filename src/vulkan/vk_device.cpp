...
namespace Vulkan {
	...
	namespace Init {
		...
		void _init_device() {
            ...
            std::vector<const char*> device_extensions = Utils::query_physical_device_support_required_extensions(physical_device);
            create_info.enabledExtensionCount = device_extensions.size();
            create_info.ppEnabledExtensionNames = device_extensions.data();

            std::vector<const char*> device_layers_enabled = Utils::query_physical_device_layers_enabled(physical_device);
            ...
            Utils::vk_check_result(
                ...
                "Vulkan create logical device success!",
                "Vulkan fail to create logical device!"
            );
